  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;History</a></li></ul>
...
echo '<tr style="color:#2db44a"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This exam has been already solved by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#C82333; border-radius:0%"><span class="glyphicon glyphicon-check" aria-hidden="true"></span>&nbsp;<span class="title1"><b>FINISHED</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div>';
...
//ranking start commented(225-247)
if(@$_GET['q']== 3) 
{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Team Members</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/logo.jpeg" width=100 height=100 alt="logo" class="img-rounded">
		 </div>
     <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="details">N.G.P. Students</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">1.Ser Ali </br>2.Goutam Mondal </br>3.Indrani Mondal </br>4.Sayan Ghosh</br>5.Youbaraj Saha</br>6.Saptam Mondal</br>7.Surojit Mondal </br>8.Sourav Chowdhury</br>9.Rajes Mondal</br>10.MD Humayun Kabir</h4></div></div>
		</p>
      </div></div>
		</p>
      </div>
