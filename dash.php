...
<body  style="background:url(../image/icn2.jpg);">
<div class="header">
<div class="row">
<div class="col-lg-6">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash.php?q=2">teachers</a></li>
    ...
    <li <?php if(@$_GET['q']==5) echo'class="active"'; ?>><a href="dash.php?q=5">view results</a></li>
...
while($row = mysqli_fetch_array($result)) {
	...
	<td><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn btn-danger" style="margin:0px; border-radius:0%;"><span class="glyphicon glyphicon-trash"  aria-hidden="true"></span>&nbsp;<span class="title1"><b>Add Questions</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div>';
...
echo  '<div class="panel"><table class="table table-striped title1">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Present Teacher Details</b></span><br /><br />
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Qualification</b></td><td><b>Address</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
  ...
  $address = $row['address'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$address.'</td><td>'.$email.'</td><td>'.$mob.'</td>
...
//request
$result = mysqli_query($con,"SELECT * FROM request") or die('Error');
echo  '<div class="panel"><table class="table table-striped title1">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Teacher Joining Request</b></span><br /><br />
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Qualification</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
  ...
  $address = $row['address'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$address.'</td><td>'.$email.'</td><td>'.$mob.'</td>
	<td><a title="Delete User" href="update.php?demail='.$email.'"><b><span<label>
  <input type="submit" name="Accept" value="Accept" id="Accept" onClick="Accept()"aria-hidden="true">
</label>
<br>
<label>
  <input type="submit" name="Decline" value="Decline" id="Decline" onClick="Decline()" aria-hidden="true">
</label></span></b></a></td></tr>';
}
$c=0;
echo '</table></br></br>
...
<tr style="color:red"><td><b>S.N.</b><td><b>name</b></td></td><td><b>Exams</b></td><td><b>Question Solved</b></td><td><b>Right</b></td><td><b>Wrong<b></td><td><b>Score</b></td>';
$c=1;
while($row = mysqli_fetch_array($result)) {
...
$c++;
	...
	echo '<tr><td>'.$c.'</td><td>'.$name.'</td><td>'.$title.'</td><td>'.$qa.'</td><td>'.$r.'</td><td>'.$w.'</td><td>'.$s.'</td></tr>';
}
$c=0;
echo '</table></div>';
