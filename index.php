...
<a href="#" class="pull-right btn sub1" style="border-radius:0%" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Student</br>Login</b></span></a></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1 text-center"><span style="color:black"><b>STUDENT LOGIN</b></span></h4>
      </div>
...
<p class="text-center"><b>Teacher Registration Form</b></p>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Teacher Fullname" class="form-control input-md" type="text">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Qualification" class="form-control input-md" type="text">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="Address" placeholder="Full Address" class="form-control input-md" type="textarea">
...
<div class="col-md-4 box">
<a href="#" data-toggle="modal" data-target="#login1">Teacher signin / signup</a></div>
<div class="col-md-4 box">
...
<div class="form-group">
<input type="text" name="uname" maxlength="20"  placeholder="Teacher Email" class="form-control"/> 
</div>
<div class="form-group">
...
<div class="form-group">
<input type="text" name="name" maxlength="20"  placeholder="Teacher Email" class="form-control"/> 
</div>
<div class="form-group">
<input type="password" name="password" maxlength="15" placeholder="Password" class="form-control"/>
</div>
