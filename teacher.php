...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span =class"log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="#" class="log log1">Teacher</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}?>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="teacher.php?q=0"><b>Dashboard</b></a>
    </div>
...
if(@$_GET['q']== 2) 
{
  $result = mysqli_query($con,"SELECT * FROM rank") or die('Error');
echo  '<div class="panel"><table class="table table-striped title1">
...
while($row = mysqli_fetch_array($result)) {
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$email.'</td><td>'.$mob.'</td>
	<td><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-ok" style="color:green;" aria-hidden="true"></span><b><span class="glyphicon glyphicon-trash" style="color:red;" aria-hidden="true"></span></b></a></td></tr>';
}
$c=0;
echo '</table></br></br>
